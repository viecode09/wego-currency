...
(function() {
  $(document).ready(function() {
    $("#to_currency option").filter(function() {
      return this.text === "IDR";
    }).attr("selected", true);
    $("#from_currency option").filter(function() {
    ...
    $("#number").keyup(function() {
      ...
      return $("#results").text(sel_value);
    });
    return $("#switch_link").click(function() {
      var from_currency_text, sel_value, to_currency_text;
